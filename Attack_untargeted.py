...
class FastGradientSignUntargeted:
    ...
    def generate(self, image, ori_class, tar_class):
        ...
        for i in range(100):
            ...
            if confirmation_label != ori_class and confirmation_confidence >= 0.9:
...
if __name__ == '__main__':
    ...
    # 实例化对象，学习率为0.01
    FGS_untargeted = FastGradientSignUntargeted(0.01)

    # 输入：原始图像、原始类别、目标类别
    FGS_untargeted.generate(original_image, original_class, target_class)
